...
assert(appSource.includes("if (isLandPropertyForBankTemplate() || isLandProjectReview()) return buildLandOpenAddressText();"), "Açıklamalardaki genel açık adres arsa/tarla biçimine bağlanmamış.");
