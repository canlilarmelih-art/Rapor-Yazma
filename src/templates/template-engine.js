...
(function () {
  ...
  const LEGACY_ALIASES = {
    ...
    DEGERLEME2025: { t: () => field("saleabilityNote") || safeCall("buildValuationMethodExplanationForAllTitleUnits") },
    ...
    DEGERLEMEYONTEMIACIKLAMASI: { t: () => safeCall("buildValuationMethodExplanationForAllTitleUnits") },
